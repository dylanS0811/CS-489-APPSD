...
public class Patient {
    ...
    public String toString() {
        return "Patient{patientId=%d, patientNumber='%s', name='%s', email='%s', phone='%s', dob=%s, address='%s'}"
                .formatted(patientId, patientNumber, getFullName(), email, phoneNumber, dateOfBirth, mailingAddress);
    }
}
